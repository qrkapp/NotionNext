...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a51
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '02ab3b8678004aa69e9e415905ef32a51',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'qrkapp', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '有意思的行业资讯研究', // 作者简介
